...
if __name__ == "__main__":
    ...
    parser.add_argument('--source-dataset', type=str, choices=['arastance', 'unifiedfc'], required=True, help='Dataset to use for fine-tuning.')
    parser.add_argument('--destination-dataset', type=str, choices=['arastance', 'unifiedfc'], required=True, help='Dataset to use for testing.')
    ...
    assert source_dataset != destination_dataset, "Source and destination datasets must be different."
